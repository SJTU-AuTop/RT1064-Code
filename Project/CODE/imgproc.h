...
void findline_lefthand_with_thres(image_t* img, uint8_t thres, int x, int y, int pts[][2], int *num);

// 右手巡线同时二值化，从(x,y)开始向上沿白边线走
void findline_righthand_with_thres(image_t* img, uint8_t thres, int x, int y, int pts[][2], int *num);
